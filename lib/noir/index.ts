...
export async function generateEntryProof(inputs?: Partial<EntryInputs>): Promise<ProofResult> {
  ...
  try {
    ...
    console.log(
      `📊 Entry proof breakdown: Witness=${witnessTime}ms, Proof=${proofTime}ms, Total=${totalTime}ms`
    );
...
export async function generateAbsorbProof(inputs?: Partial<AbsorbInputs>): Promise<ProofResult> {
  ...
  try {
    ...
    console.log(
      `📊 Absorb proof breakdown: Witness=${witnessTime}ms, Proof=${proofTime}ms, Total=${totalTime}ms`
    );
...
export async function generateSendProof(inputs?: Partial<SendInputs>): Promise<ProofResult> {
  ...
  try {
    ...
    console.log(
      `📊 Send proof breakdown: Witness=${witnessTime}ms, Proof=${proofTime}ms, Total=${totalTime}ms`
    );
