...
export function generatePublicKey(privateKey: bigint): Point {
  ...
  const BASE8_X = BigInt(
    "5299619240641551281634865583518297030282874472190772894086521144482721001553"
  );
  const BASE8_Y = BigInt(
  ...
  console.log(
    ...
    publicKeyPoint.x.toString(16),
    publicKeyPoint.y.toString(16)
  );
...
export async function performDHKeyExchange(
  ...
  const receiverPoint = babyjubjub.Point.fromAffine({
    x: receiverPublicKey.x,
    y: receiverPublicKey.y,
  });
